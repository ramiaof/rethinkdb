...
public:
    ...
    public:
        ...
        server_business_card_t(
                const mailbox_addr_t<request_t> &ra,
                const mailbox_addr_t<int> &rta) :
            request_addr(ra), relinquish_tickets_addr(rta) { }
        mailbox_addr_t<request_t> request_addr;
        mailbox_addr_t<int> relinquish_tickets_addr;
    ...
    public:
        ...
        client_business_card_t(
                ...
                const mailbox_addr_t<server_business_card_t> &ia,
                const mailbox_addr_t<int> &gta,
                const mailbox_addr_t<int> &rta) :
        ...
        mailbox_addr_t<server_business_card_t> intro_addr;
